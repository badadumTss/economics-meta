...
What I had troubles to find was a review of the Meta business
model. There's not musch literature available on that, but fortunately
the specialized press seemed to agree on which are the key components
of it. On \ref{sec:analysis} there is an interpretation of the
business model of Meta, and more in detail on the business model of
its main social platforms (instagram and facebook).
